...
import { Trash2, UtensilsCrossed, Dumbbell, Clock, Save } from "lucide-react";
  ...
  return (
      <div className="ft-card p-5">
        ...
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-white font-bold uppercase">Today's Activity</h2>

          <Button onClick={handleSaveDay} className="bg-green-600 hover:bg-green-700">
