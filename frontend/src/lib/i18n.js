...
Object.assign(dictionary, {
  ...
  "Deleting…": "Изтриване…",
  "Camera preview": "Преглед на камерата",
  "Capture photo": "Заснеми снимка",
  "Close camera": "Затвори камерата",
  "Waiting for camera permission\u2026": "Изчаква се разрешение за камерата…",
  "Camera is unavailable in this browser. Open the HTTPS site or choose from gallery.": "Камерата не е достъпна в този браузър. Отвори HTTPS адреса или избери от галерията.",
  "Camera permission denied. Allow camera access in your browser settings and try again.": "Достъпът до камерата е отказан. Разреши го в настройките на браузъра и опитай отново.",
  "No camera found. Connect a camera or choose from gallery.": "Няма намерена камера. Свържи камера или избери от галерията.",
  "Could not start the camera. Close other apps using it and try again.": "Камерата не може да се включи. Затвори другите приложения, които я използват, и опитай отново.",
  "Application update": "Обновяване на приложението",
  "A new version is available.": "Има нова версия на приложението.",
  "Update now": "Обнови",
  "Checking\u2026": "Проверка…",
  "Save or discard your changes before updating.": "Запази или откажи промените си преди обновяване.",
  "Wait for saving and offline sync to finish before updating.": "Изчакай записването и offline синхронизацията да приключат.",
  "Connect to the internet before updating.": "Свържи се с интернет преди обновяване.",
  "Update unavailable. Please try again when online.": "Обновяването не е достъпно. Опитай отново при наличен интернет.",
